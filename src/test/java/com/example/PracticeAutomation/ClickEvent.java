...
public void testClickEvent2() throws Exception {
	...
	ClickEventPage.takeScreenShot("Clickevents.jpg",ClickEventPage.getHeadline());
	ClickEventPage.takeScreenShot("screenshots","clickeventscatbutton.jpg",ClickEventPage.getCat());
}
